...
TYPE mantle
  ...
  TYPE unit_cell
     ...
     REAL(sp)::vs_obs,vp_obs,K_obs,G_obs
...
!!$
  ...
  FUNCTION depth2dT(depth,mtzdepth,dPdT)
    IMPLICIT NONE
    REAL(sp),INTENT(in)::depth,mtzdepth,dPdT
    REAL(sp)::depth2dT,dzdT,dPdz
