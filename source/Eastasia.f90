  ...
  do kk=1,10
     do ii=1,5
        ...
        HAWAII=load_seismo_hmt(HAWAII_REF_COMP,3&
             &,'../input/East_Asia_Tauzin.csv',MTZ_TOPO_NORMALIZE_HAWAII,velocity_contrast_410,14)
        ...
        do jj=1,7
           ...
           CALL data_table_output(HAWAII,HAWAII_REF_MANTLE,'../data/ASIA/')
