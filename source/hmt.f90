PROGRAM hmt
  ...
  do ii=1,5
     ...
     HAWAII=load_seismo_hmt(HAWAII_REF_COMP,3&
          &,'../input/&
          &modified_input_hmt16.dat',MTZ_TOPO_NORMALIZE_HAWAII,velocity_contrast_410,14) 
    ...
    ! loop through dihedral angle values
     ...
     do jj=1,7
        ...
        CALL data_table_output(HAWAII,HAWAII_REF_MANTLE,'../data/HMT/')
        CALL melt_gmt_output(HAWAII,HAWAII_REF_MANTLE,'../data/HMT/')
     end do
